...
access_tuple:
    T_ID T_POINT T_NUM
    {
        std::cout << "access_tuple -> T_ID T_POINT T_NUM" << std::endl;
    }
;
...
|
    ...
    {
        std::cout << "assignment -> access_tuple T_ASSIGN expression T_SEMICOLON" << std::endl;
    }
;
...
|
    access_tuple
    {
        std::cout << "expression -> access_tuple" << std::endl;
    }
;
