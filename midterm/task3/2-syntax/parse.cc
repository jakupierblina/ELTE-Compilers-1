// Generated by Bisonc++ V5.02.00 on Mon, 19 Oct 2020 19:08:56 +0200
...
PI__ const s_productionInfo[] = 
{
     ...
     {297, 3}, // 4: declaration (T_INTEGER) ->  T_INTEGER id T_SEMICOLON
     {297, 3}, // 5: declaration (T_BOOLEAN) ->  T_BOOLEAN id T_SEMICOLON
     ...
     {299, 1}, // 14: statement ->  label
     {299, 1}, // 15: statement ->  goto_statement
     {306, 3}, // 16: goto_statement (T_GOTO) ->  T_GOTO T_LABEL T_SEMICOLON
     {298, 1}, // 17: id (T_ID) ->  T_ID
     {298, 1}, // 18: id (T_LABEL) ->  T_LABEL
     {305, 2}, // 19: label (T_LABEL) ->  T_LABEL T_COLON
     {300, 4}, // 20: assignment (T_ASSIGN) ->  id T_ASSIGN expression T_SEMICOLON
     {301, 5}, // 21: read (T_READ) ->  T_READ T_OPEN id T_CLOSE T_SEMICOLON
     {302, 5}, // 22: write (T_WRITE) ->  T_WRITE T_OPEN expression T_CLOSE T_SEMICOLON
     {303, 5}, // 23: branch (T_IF) ->  T_IF expression T_THEN statements T_ENDIF
     {303, 7}, // 24: branch (T_IF) ->  T_IF expression T_THEN statements T_ELSE statements T_ENDIF
     {304, 5}, // 25: loop (T_WHILE) ->  T_WHILE expression T_DO statements T_DONE
     {307, 1}, // 26: expression (T_NUM) ->  T_NUM
     {307, 1}, // 27: expression (T_TRUE) ->  T_TRUE
     {307, 1}, // 28: expression (T_FALSE) ->  T_FALSE
     {307, 3}, // 29: expression (T_ADD) ->  expression T_ADD expression
     {307, 3}, // 30: expression (T_SUB) ->  expression T_SUB expression
     {307, 3}, // 31: expression (T_MUL) ->  expression T_MUL expression
     {307, 3}, // 32: expression (T_DIV) ->  expression T_DIV expression
     {307, 3}, // 33: expression (T_MOD) ->  expression T_MOD expression
     {307, 3}, // 34: expression (T_LESS) ->  expression T_LESS expression
     {307, 3}, // 35: expression (T_GR) ->  expression T_GR expression
     {307, 3}, // 36: expression (T_EQ) ->  expression T_EQ expression
     {307, 3}, // 37: expression (T_AND) ->  expression T_AND expression
     {307, 3}, // 38: expression (T_OR) ->  expression T_OR expression
     {307, 2}, // 39: expression (T_NOT) ->  T_NOT expression
     {307, 3}, // 40: expression (T_OPEN) ->  T_OPEN expression T_CLOSE
     {307, 1}, // 41: expression ->  id
     {308, 1}, // 42: program_$ ->  program
};
...
#line 71 "while.y"
        {
         std::cout << "declaration -> T_INTEGER id T_SEMICOLON" << std::endl;
         }
        break;
...
#line 76 "while.y"
        {
         std::cout << "declaration -> T_BOOLEAN id T_SEMICOLON" << std::endl;
         }
        break;
...
#line 130 "while.y"
        {
         std::cout << "statement -> goto_statement" << std::endl;
         }
        break;
...
#line 137 "while.y"
        {
         std::cout << "goto_statement -> T_GOTO T_LABEL T_SEMICOLON" << std::endl;
         }
        break;
...
#line 163 "while.y"
        {
         std::cout << "assignment -> id T_ASSIGN expression T_SEMICOLON" << std::endl;
         }
        break;
...
#line 170 "while.y"
        {
         std::cout << "read -> T_READ T_OPEN id T_CLOSE T_SEMICOLON" << std::endl;
         }
        break;
...
#line 278 "while.y"
        {
         std::cout << "expression -> id" << std::endl;
         }
        break;
